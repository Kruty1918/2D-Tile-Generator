...
namespace Systems.CameraController_
{
    public class CameraController : MonoBehaviour
    {
        ...
        private void PanningInertia()
        {
            ...
            if (_panVelocity != Vector2.zero)
            {
                ...
                _cameraToMove.transform.localPosition += new Vector3(-_panVelocity.x / (1000 * (1 / _cameraToMove.orthographicSize)), -_panVelocity.y / (1000 * (1 / _cameraToMove.orthographicSize)), 0);
                LimitCameraMovement();
            }
        }
        ...
        private void LimitCameraMovement()
        {
            ...
            transform.position = new Vector3(xCord, yCord, _cameraToMove.transform.position.z);
        }
    }
}